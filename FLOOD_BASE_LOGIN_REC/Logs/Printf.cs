...
namespace bot.Logs
{
    public class Printf
    {
        ...
        public static void warning(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.Yellow, ConsoleColor.Black, data, newLine);
        }
        public static void warnDark(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.DarkYellow, ConsoleColor.Black, data, newLine);
        }
        public static void white(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.White, ConsoleColor.Black, data, newLine);
        }
        public static void blue(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.Blue, ConsoleColor.Black, data, newLine);
        }
        public static void danger(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.Red, ConsoleColor.Black, data, newLine);
        }
        public static void b_danger(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.White, ConsoleColor.Red, data, newLine);
        }
        public static void sucess(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.Green, ConsoleColor.Black, data, newLine);
        }
        public static void info(string txt, bool data = false, bool newLine = true)
        {
            debug(txt, ConsoleColor.Gray, ConsoleColor.Black, data, newLine);
        }

        public static void roxo(string txt, bool data = false, bool newLine = true)
        {
